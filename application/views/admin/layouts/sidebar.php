        ...
        <div class="sidebar-menu">
            <ul class="menu">
                ...
                <li class="sidebar-item  <?= ($this->uri->segment(2) == 'laporan') ? 'active' : ''; ?>">
                    <a href="<?= base_url('admin/laporan/index') ?>" class='sidebar-link'>
                ...
                <!-- <li class="sidebar-item <?= ($this->uri->segment(2) == 'toko') ? 'active' : ''; ?> has-sub">
                    ...
                    <?php
                    $data_toko = $this->db->get('toko')->result();
                    ?>
                    <ul class="submenu <?= ($this->uri->segment(2) == 'toko') ? 'active' : ''; ?>">
                        <?php foreach ($data_toko as $toko) : ?>
                            <li class="submenu-item <?= ($this->uri->segment(2) == 'toko' && $this->uri->segment(4) == $toko->id_toko) ? 'active' : ''; ?>">
                                <a href="<?= base_url('admin/toko/show/' . $toko->id_toko) ?>"><?= $toko->nama_toko ?></a>
                            </li>
                        <?php endforeach; ?>
                    </ul>
                </li> -->
