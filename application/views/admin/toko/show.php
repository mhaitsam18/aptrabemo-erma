            ...
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <!-- <a href="<?= base_url('admin/penjualan/index/' . $toko->id_toko) ?>" class="btn btn-primary mb-3 float-end">Lihat Pemesanan</a> -->
                            <table>
                                <caption>
            ...
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <!-- <a href="<?= base_url('admin/produk/create/' . $toko->id_toko) ?>" class="btn btn-primary mb-3">Tambah Data Produk</a> -->
                                ...
                                <tbody>
                                    ...
                                    foreach ($data_produk as $produk) : ?>
                                        <tr>
                                            ...
                                            <td>
                                                <!-- <a href="<?= base_url('admin/Produk/delete/' . $produk->id_produk) ?>" class="badge bg-danger">Hapus</a>
                                                <a href="<?= base_url('admin/Produk/edit/' . $produk->id_produk) ?>" class="badge bg-success">Ubah</a> -->
                                                <a href="<?= base_url('admin/Produk/show/' . $produk->id_produk) ?>" class="badge bg-info">Detail</a>
                                            </td>
