                        ...
                        <div class="card-body">
                            ...
                            <form action="<?= base_url('pedagang/Produk/create/' . $toko->id_toko) ?>" method="post" enctype="multipart/form-data">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control <?= (form_error('nama_toko')) ? 'is-invalid' : '' ?>" name="nama_toko" id="nama_toko" value="<?= $toko->nama_toko; ?>" disabled>
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control <?= (form_error('nama_produk')) ? 'is-invalid' : '' ?>" name="nama_produk" id="nama_produk" value="<?= set_value('nama_produk'); ?>">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="number" class="form-control <?= (form_error('harga_beli')) ? 'is-invalid' : '' ?>" name="harga_beli" id="harga_beli" value="<?= set_value('harga_beli'); ?>" step="any">
                                ...
                                <!-- <div class="mb-3">
                                        ...
                                        <input type="number" class="form-control <?= (form_error('harga_reseller')) ? 'is-invalid' : '' ?>" name="harga_reseller" id="harga_reseller" value="<?= set_value('harga_reseller'); ?>" step="any">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="number" class="form-control <?= (form_error('harga_konsumen')) ? 'is-invalid' : '' ?>" name="harga_konsumen" id="harga_konsumen" value="<?= set_value('harga_konsumen'); ?>" step="any">
                                ...
                                <div class="mb-3 row">
                                    <div class="col">
                                        ...
                                        <input type="number" class="form-control <?= (form_error('berat')) ? 'is-invalid' : '' ?>" name="berat" id="berat" value="<?= set_value('berat'); ?>" step="any">
                                    ...
                                    <div class="col">
                                        ...
                                        <input type="number" class="form-control <?= (form_error('satuan_berat')) ? 'is-invalid' : '' ?>" name="satuan_berat" id="satuan_berat" value="<?= set_value('satuan_berat'); ?>" step="any" placeholder="gram / kg / ons">
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea class="form-control <?= (form_error('tentang_produk')) ? 'is-invalid' : '' ?>" name="tentang_produk" id="tentang_produk"><?= set_value('tentang_produk'); ?></textarea>
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea class="form-control <?= (form_error('keterangan')) ? 'is-invalid' : '' ?>" name="keterangan" id="keterangan"><?= set_value('keterangan'); ?></textarea>
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea class="form-control <?= (form_error('tag')) ? 'is-invalid' : '' ?>" name="tag" id="tag"><?= set_value('tag'); ?></textarea>
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="number" class="form-control <?= (form_error('stok')) ? 'is-invalid' : '' ?>" name="stok" id="stok" value="<?= set_value('stok'); ?>">
